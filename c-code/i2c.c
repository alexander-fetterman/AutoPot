...
void i2c_init() {
  	...
  	/* Open device on /dev/i2c-1 
      	 the default on Raspberry Pi Zero W */
...
float adc_read() {
	/* Declare a float to hold the conversion result */
	float res;
	...
	/* Convert 16 bit adc value to voltage float */
  	res = val * VPS;
